...
<label>Lock<input type="checkbox" id="gsl" checked></label>
<label>Color<input type="color" id="gcol" value="${C.gridColor}" style="width:40px;height:22px;padding:0;border:none"></label>
<label>Opacity%<input type="range" id="gopa" min="5" max="100" value="${Math.round(C.gridAlpha * 100)}" style="width:70px" oninput="this.nextElementSibling.textContent=this.value"><span>${Math.round(C.gridAlpha * 100)}</span></label>
<label>Thick<input type="range" id="gthk" min="1" max="5" value="${C.gridThick}" style="width:50px" oninput="this.nextElementSibling.textContent=this.value"><span>${C.gridThick}</span></label>
<div class="sep"></div>
...
<label>GH pos<input type="range" id="ghy" min="0" max="100" value="${Math.round(C.guideHY * 100)}" style="width:70px"></label>
<label>GV pos<input type="range" id="gvx" min="0" max="100" value="${Math.round(C.guideVX * 100)}" style="width:70px"></label>
<div class="sep"></div>
<label style="font-weight:600;color:var(--acc)">Pixel Grid</label>
<label>PxGrid Color<input type="color" id="pgcol" value="${C.pxGridColor}" style="width:40px;height:22px;padding:0;border:none"></label>
<label>PxGrid Opacity%<input type="range" id="pgopa" min="5" max="100" value="${Math.round(C.pxGridAlpha * 100)}" style="width:70px" oninput="this.nextElementSibling.textContent=this.value"><span>${Math.round(C.pxGridAlpha * 100)}</span></label>
<label>PxGrid Thick<input type="range" id="pgthk" min="1" max="3" value="${C.pxGridThick}" style="width:50px" oninput="this.nextElementSibling.textContent=this.value"><span>${C.pxGridThick}</span></label>
<div class="mb"><button class="bsc" onclick="U.cMo()">Cancel</button><button class="bp" onclick="U.applyGrid()">OK</button></div>`);
  ...
  function applyGrid() {
    ...
    if (pgcEl) {
      ...
      C.pxGridAlpha = (+document.getElementById('pgopa').value) / 100;
      C.pxGridThick = +document.getElementById('pgthk').value;
    }
    C.render(); cMo();
  }
